...
execute as @e[type=armor_stand,tag=is_parent] run scoreboard players operation @s self_matrix_0 *= #-1 constants
...
execute as @e[type=armor_stand,tag=is_parent] run scoreboard players operation @s self_matrix_1 *= #-1 constants
...
execute as @e[type=armor_stand,tag=is_parent] run scoreboard players operation @s self_matrix_2 *= #-1 constants
