...
## add parent
execute as @e[type=armor_stand,tag=ray,tag=add_parent,tag=action] at @s positioned ~ ~-0.75 ~ as @e[type=armor_stand,tag=block,distance=..0.5,limit=1] run scoreboard players set @s temp 1
...
## select parent
execute as @e[type=armor_stand,tag=ray,tag=select_parent,tag=action] at @s positioned ~ ~-0.75 ~ as @e[type=armor_stand,tag=block,distance=..0.5,limit=1] run scoreboard players set @s temp 1
...
## delete
execute as @e[type=armor_stand,tag=ray,tag=delete,tag=action] at @s positioned ~ ~-0.75 ~ as @e[type=armor_stand,tag=block,distance=..0.5,limit=1] run kill @s
