...
## x
execute as @e[type=armor_stand,tag=has_parent] run scoreboard players set @s correction_x 0
...
execute as @e[type=armor_stand,tag=has_parent] run scoreboard players operation @s temp *= @s parent_sin_x
execute as @e[type=armor_stand,tag=has_parent] run scoreboard players operation @s temp /= #1000 constants
...
execute as @e[type=armor_stand,tag=has_parent] run scoreboard players operation @s temp /= #1000 constants
execute as @e[type=armor_stand,tag=has_parent] run scoreboard players operation @s temp *= @s parent_cos_x
execute as @e[type=armor_stand,tag=has_parent] run scoreboard players operation @s temp /= #1000 constants
execute as @e[type=armor_stand,tag=has_parent] run scoreboard players operation @s correction_x += @s temp
...
execute as @e[type=armor_stand,tag=has_parent] run scoreboard players operation @s temp *= @s parent_cos_x
execute as @e[type=armor_stand,tag=has_parent] run scoreboard players operation @s temp /= #1000 constants
execute as @e[type=armor_stand,tag=has_parent] run scoreboard players operation @s temp *= @s parent_cos_y
execute as @e[type=armor_stand,tag=has_parent] run scoreboard players operation @s temp /= #1000 constants
execute as @e[type=armor_stand,tag=has_parent] run scoreboard players operation @s correction_x -= @s temp
...
execute as @e[type=armor_stand,tag=has_parent] run scoreboard players operation @s correction_x /= #24 constants
execute as @e[type=armor_stand,tag=has_parent] run scoreboard players operation @s correction_x += @s initial_offset_x


## y
execute as @e[type=armor_stand,tag=has_parent] run scoreboard players set @s correction_y 0
...
execute as @e[type=armor_stand,tag=has_parent] run scoreboard players operation @s temp *= @s initial_offset_z
execute as @e[type=armor_stand,tag=has_parent] run scoreboard players operation @s temp /= #1000 constants
execute as @e[type=armor_stand,tag=has_parent] run scoreboard players operation @s temp *= @s parent_sin_y
execute as @e[type=armor_stand,tag=has_parent] run scoreboard players operation @s temp /= #1000 constants
execute as @e[type=armor_stand,tag=has_parent] run scoreboard players operation @s correction_y += @s temp
...
execute as @e[type=armor_stand,tag=has_parent] run scoreboard players operation @s correction_y /= #24 constants
execute as @e[type=armor_stand,tag=has_parent] run scoreboard players operation @s correction_y += @s initial_offset_y

## z
execute as @e[type=armor_stand,tag=has_parent] run scoreboard players set @s correction_z 0
...
execute as @e[type=armor_stand,tag=has_parent] run scoreboard players operation @s correction_z /= #24 constants
...
execute as @e[type=armor_stand,tag=has_parent] run scoreboard players operation @s temp = @s correction_x
...
execute as @e[type=armor_stand,tag=has_parent] run scoreboard players operation @s temp = @s correction_y
execute as @e[type=armor_stand,tag=has_parent] run scoreboard players operation @s temp *= @s parent_matrix_1
execute as @e[type=armor_stand,tag=has_parent] run scoreboard players operation @s temp /= #1000 constants
execute as @e[type=armor_stand,tag=has_parent] run scoreboard players operation @s temp *= #-1 constants
execute as @e[type=armor_stand,tag=has_parent] run scoreboard players operation @s self_pos_x += @s temp
execute as @e[type=armor_stand,tag=has_parent] run scoreboard players operation @s temp = @s correction_z
