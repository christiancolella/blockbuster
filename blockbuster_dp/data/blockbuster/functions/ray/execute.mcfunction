...
data modify entity @e[type=armor_stand,tag=block,tag=new_copy,limit=1] ArmorItems[3] set from entity @e[type=armor_stand,tag=block,scores={temp=1},limit=1] ArmorItems[3]
execute as @e[type=armor_stand,tag=block,tag=new_copy] store result score @s initial_pos_x run data get entity @s Pos[0] 1000
execute as @e[type=armor_stand,tag=block,tag=new_copy] store result score @s initial_pos_y run data get entity @s Pos[1] 1000
execute as @e[type=armor_stand,tag=block,tag=new_copy] store result score @s initial_pos_z run data get entity @s Pos[2] 1000
scoreboard players operation @e[type=armor_stand,tag=block,tag=new_copy] initial_rot_x = @e[type=armor_stand,tag=block,scores={temp=1}] initial_rot_x
scoreboard players operation @e[type=armor_stand,tag=block,tag=new_copy] initial_rot_y = @e[type=armor_stand,tag=block,scores={temp=1}] initial_rot_y
scoreboard players operation @e[type=armor_stand,tag=block,tag=new_copy] initial_rot_z = @e[type=armor_stand,tag=block,scores={temp=1}] initial_rot_z
scoreboard players operation @e[type=armor_stand,tag=block,tag=new_copy] anim_length = @e[type=armor_stand,tag=block,scores={temp=1}] anim_length
...
function blockbuster:misc/copy
scoreboard players set @e[type=armor_stand,tag=block] temp 0
