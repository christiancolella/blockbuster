...
execute at @a[scores={temp=1,edit=1..}] as @e[type=armor_stand,tag=block,tag=hidden,distance=..8] run data modify entity @s ArmorItems[3] set value {id:"minecraft:barrier",Count:1b}
