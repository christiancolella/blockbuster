...
## options
execute as @a[scores={edit=17..18,global=4,temp=2}] run scoreboard players set @s edit 3
execute as @a[scores={edit=17..20,global=55,temp=2}] run scoreboard players set @s edit 2
...
## parent
execute as @a[scores={edit=3,global=9,temp=2}] run scoreboard players set @s edit 17
