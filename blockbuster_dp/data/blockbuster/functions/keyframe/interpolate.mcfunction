...
# linear pos
scoreboard players set @e[type=armor_stand,tag=block,scores={temp=1,pos_trans_type=1}] temp 2
...
# linear rot
scoreboard players set @e[type=armor_stand,tag=block,scores={temp=1,rot_trans_type=1}] temp 2
...
# ease in pos
scoreboard players set @e[type=armor_stand,tag=block,scores={temp=1,pos_trans_type=2}] temp 2
...
# ease in rot
scoreboard players set @e[type=armor_stand,tag=block,scores={temp=1,rot_trans_type=2}] temp 2
...
# ease out pos
scoreboard players set @e[type=armor_stand,tag=block,scores={temp=1,pos_trans_type=3}] temp 2
...
# ease out rot
scoreboard players set @e[type=armor_stand,tag=block,scores={temp=1,rot_trans_type=3}] temp 2
...
# ease in and out pos
scoreboard players set @e[type=armor_stand,tag=block,scores={temp=1,pos_trans_type=4}] temp 2
...
# ease in and out rot
scoreboard players set @e[type=armor_stand,tag=block,scores={temp=1,rot_trans_type=4}] temp 2
