...
scoreboard players operation @e[type=armor_stand,tag=block,scores={temp=1}] initial_pos_x -= @e[type=armor_stand,tag=block,tag=!has_parent,scores={global=2}] initial_pos_x
execute if entity @e[type=armor_stand,tag=block,tag=!has_parent,scores={global=2},limit=1] run scoreboard players operation @e[type=armor_stand,tag=block,scores={temp=1}] initial_pos_x *= #-1 constants
