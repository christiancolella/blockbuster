...
scoreboard players operation @e[type=armor_stand,tag=block,scores={temp=2}] initial_pos_x += @e[type=armor_stand,tag=block,tag=has_parent,scores={global=2}] initial_pos_x
scoreboard players operation @e[type=armor_stand,tag=block,scores={temp=2}] initial_pos_x -= @e[type=armor_stand,tag=block,tag=!has_parent,scores={global=2}] initial_pos_x
execute if entity @e[type=armor_stand,tag=block,tag=!has_parent,scores={global=2}] run scoreboard players operation @e[type=armor_stand,tag=block,scores={temp=2}] initial_pos_x *= #-1 constants
scoreboard players operation @e[type=armor_stand,tag=block,scores={temp=2}] initial_pos_y -= @e[type=armor_stand,tag=block,scores={global=2}] initial_pos_y
scoreboard players operation @e[type=armor_stand,tag=block,scores={temp=2}] initial_pos_z -= @e[type=armor_stand,tag=block,scores={global=2}] initial_pos_z
...
execute if entity @e[type=armor_stand,tag=block,tag=has_parent,scores={global=1}] run function blockbuster:parent/on_add