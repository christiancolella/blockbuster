...
execute as @a[scores={edit=11}] run replaceitem entity @s hotbar.0 netherite_boots{display:{Name:"{\"text\":\"Remove Keyframe\",\"color\":\"red\",\"italic\":false}"},CustomModelData:32}
execute as @a[scores={edit=11}] run replaceitem entity @s hotbar.1 netherite_boots{display:{Name:"{\"text\":\"Move Keyframe +0.05 seconds\",\"color\":\"#663bb3\",\"italic\":false}"},CustomModelData:49}
execute as @a[scores={edit=11}] run replaceitem entity @s hotbar.2 netherite_boots{display:{Name:"{\"text\":\"Move Keyframe -0.05 seconds\",\"color\":\"#663bb3\",\"italic\":false}"},CustomModelData:50}
execute as @a[scores={edit=11}] run replaceitem entity @s hotbar.3 netherite_boots{display:{Name:"{\"text\":\"Transition Type [+]\",\"color\":\"#232393\",\"italic\":false}"},CustomModelData:33}
execute as @a[scores={edit=11}] run replaceitem entity @s hotbar.4 air
execute as @a[scores={edit=10..11}] run replaceitem entity @s hotbar.5 netherite_boots{display:{Name:"{\"text\":\"List All Keyframes\",\"color\":\"#663bb3\",\"italic\":false}"},CustomModelData:51}
execute as @a[scores={edit=10..11}] run replaceitem entity @s hotbar.6 netherite_boots{display:{Name:"{\"text\":\"Jump to Previous Keyframe\",\"color\":\"#663bb3\",\"italic\":false}"},CustomModelData:52}
execute as @a[scores={edit=10..11}] run replaceitem entity @s hotbar.7 netherite_boots{display:{Name:"{\"text\":\"Jump to Next Keyframe\",\"color\":\"#663bb3\",\"italic\":false}"},CustomModelData:53}
