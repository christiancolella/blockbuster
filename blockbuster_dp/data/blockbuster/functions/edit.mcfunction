...
execute as @a[scores={edit=10..11}] run replaceitem entity @s hotbar.6 netherite_boots{display:{Name:"{\"text\":\"Jump to Previous Keyframe\",\"color\":\"#663bb3\",\"italic\":false}"},CustomModelData:51}
execute as @a[scores={edit=10..11}] run replaceitem entity @s hotbar.7 netherite_boots{display:{Name:"{\"text\":\"Jump to Next Keyframe\",\"color\":\"#663bb3\",\"italic\":false}"},CustomModelData:52}
