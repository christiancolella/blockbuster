...
execute as @e[type=armor_stand,tag=locked] if score @s self_uuid_0 = @e[type=armor_stand,tag=hitbox,nbt={HandItems:[{id:"minecraft:bee_spawn_egg",Count:1b,tag:{CustomModelData:1}}]},scores={temp=1},limit=1] parent_uuid_0 if score @s self_uuid_1 = @e[type=armor_stand,tag=hitbox,nbt={HandItems:[{id:"minecraft:bee_spawn_egg",Count:1b,tag:{CustomModelData:1}}]},scores={temp=1},limit=1] parent_uuid_1 if score @s self_uuid_2 = @e[type=armor_stand,tag=hitbox,nbt={HandItems:[{id:"minecraft:bee_spawn_egg",Count:1b,tag:{CustomModelData:1}}]},scores={temp=1},limit=1] parent_uuid_2 if score @s self_uuid_3 = @e[type=armor_stand,tag=hitbox,nbt={HandItems:[{id:"minecraft:bee_spawn_egg",Count:1b,tag:{CustomModelData:1}}]},scores={temp=1},limit=1] parent_uuid_3 run data modify entity @s HandItems[0] set from entity @e[type=armor_stand,tag=hitbox,nbt={HandItems:[{id:"minecraft:bee_spawn_egg",Count:1b,tag:{CustomModelData:1}}]},scores={temp=1},limit=1] HandItems[0]
...
execute as @e[type=armor_stand,tag=locked] if score @s self_uuid_0 = @e[type=armor_stand,tag=hitbox,scores={temp=1},limit=1] parent_uuid_0 if score @s self_uuid_1 = @e[type=armor_stand,tag=hitbox,scores={temp=1},limit=1] parent_uuid_1 if score @s self_uuid_2 = @e[type=armor_stand,tag=hitbox,scores={temp=1},limit=1] parent_uuid_2 if score @s self_uuid_3 = @e[type=armor_stand,tag=hitbox,scores={temp=1},limit=1] parent_uuid_3 if score @e[type=armor_stand,tag=hitbox,scores={temp=1},limit=1] has_hand_item matches 1 run data modify entity @s ArmorItems[3] set from entity @e[type=armor_stand,tag=hitbox,scores={temp=1},limit=1] HandItems[0]
...
execute as @e[type=armor_stand,tag=last_selected,tag=!selected,limit=1] run scoreboard players set @s temp 1
execute as @e[type=armor_stand,tag=hitbox] if score @s parent_uuid_0 = @e[type=armor_stand,scores={temp=1},limit=1] self_uuid_0 if score @s parent_uuid_1 = @e[type=armor_stand,scores={temp=1},limit=1] self_uuid_1 if score @s parent_uuid_2 = @e[type=armor_stand,scores={temp=1},limit=1] self_uuid_2 if score @s parent_uuid_3 = @e[type=armor_stand,scores={temp=1},limit=1] self_uuid_3 run kill @s
...
team join blue @e[type=armor_stand,tag=locked]
team join yellow @e[type=armor_stand,scores={edit=4}]
team join yellow @e[type=armor_stand,tag=awaiting_parent]
team join gold @e[type=armor_stand,scores={edit=9}]
team join red @e[type=armor_stand,scores={edit=5}]
team join dark_gray @e[type=armor_stand,scores={edit=6}]
team join dark_red @e[type=armor_stand,scores={edit=8}]
team join aqua @e[type=armor_stand,scores={edit=10..17}]
team join aqua @e[type=armor_stand,scores={edit=39..44}]
team join light_purple @e[type=armor_stand,scores={edit=23..28}]
team join dark_aqua @e[type=armor_stand,scores={edit=45..48}]
team join dark_purple @e[type=armor_stand,scores={edit=29..31}]
team join red @e[type=armor_stand,scores={edit=32}]
team join dark_purple @e[type=armor_stand,scores={edit=49..52}]
team join dark_blue @e[type=armor_stand,scores={edit=34..38}]
team join green @e[type=armor_stand,scores={edit=18}]
team join red @e[type=armor_stand,scores={edit=19}]
team join dark_green @e[type=armor_stand,scores={edit=57}]
team join red @e[type=armor_stand,scores={edit=58}]
team join dark_blue @e[type=armor_stand,scores={edit=55}]
team join dark_red @e[type=armor_stand,scores={edit=59}]
team join dark_blue @e[type=armor_stand,tag=parent_glow]
