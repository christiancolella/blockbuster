...
execute if entity @e[type=armor_stand,tag=block,scores={temp=1}] run function blockbuster:misc/delete_hierarchy
scoreboard players set @e[type=armor_stand,tag=block,scores={temp=3}] temp 1
