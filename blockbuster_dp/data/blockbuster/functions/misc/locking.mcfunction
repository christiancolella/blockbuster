...
execute as @e[type=armor_stand,tag=block,tag=locking] store result score @s temp run data get entity @s ArmorItems[0].tag.InitialPos[0]
...
execute as @e[type=armor_stand,tag=block,tag=locking] store result score @s temp run data get entity @s ArmorItems[0].tag.InitialPos[1]
...
execute as @e[type=armor_stand,tag=block,tag=locking] store result score @s temp run data get entity @s ArmorItems[0].tag.InitialPos[2]
...
execute as @e[type=armor_stand,tag=block,tag=locking] run data modify entity @s ArmorItems[0].tag.RotX append from entity @s Pose.Head[0]
