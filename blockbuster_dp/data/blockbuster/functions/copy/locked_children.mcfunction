...
execute if entity @e[type=armor_stand,tag=locked,tag=is_parent,scores={temp=3}] run tag @e[type=armor_stand,tag=locked,scores={temp=4}] add is_parent
execute if entity @e[type=armor_stand,tag=locked,tag=has_parent,scores={temp=3}] run tag @e[type=armor_stand,tag=locked,scores={temp=4}] add has_parent
