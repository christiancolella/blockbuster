...
execute at @s run summon armor_stand ~-0.25 ~0.226 ~ {Small:1b,Invisible:1b,NoGravity:1b,ShowArms:1b,NoBasePlate:1b,DisabledSlots:4079166,Tags:["new_hitbox"]}
execute at @s run summon armor_stand ~-0.25 ~0.226 ~-0.25 {Small:1b,Invisible:1b,NoGravity:1b,ShowArms:1b,NoBasePlate:1b,DisabledSlots:4079166,Tags:["new_hitbox"]}
scoreboard players operation @e[type=armor_stand,tag=new_hitbox] parent_uuid_0 = @s self_uuid_0
scoreboard players operation @e[type=armor_stand,tag=new_hitbox] parent_uuid_1 = @s self_uuid_1
scoreboard players operation @e[type=armor_stand,tag=new_hitbox] parent_uuid_2 = @s self_uuid_2
scoreboard players operation @e[type=armor_stand,tag=new_hitbox] parent_uuid_3 = @s self_uuid_3
