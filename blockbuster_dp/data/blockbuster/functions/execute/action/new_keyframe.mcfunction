...
# position
scoreboard players operation @e[type=area_effect_cloud,tag=new_keyframe] parent_uuid_0 = @s[scores={edit=29}] self_uuid_0
scoreboard players operation @e[type=area_effect_cloud,tag=new_keyframe] parent_uuid_1 = @s[scores={edit=29}] self_uuid_1
scoreboard players operation @e[type=area_effect_cloud,tag=new_keyframe] parent_uuid_2 = @s[scores={edit=29}] self_uuid_2
scoreboard players operation @e[type=area_effect_cloud,tag=new_keyframe] parent_uuid_3 = @s[scores={edit=29}] self_uuid_3
...
# rotation
scoreboard players operation @e[type=area_effect_cloud,tag=new_keyframe] parent_uuid_0 = @s[scores={edit=30}] self_uuid_0
scoreboard players operation @e[type=area_effect_cloud,tag=new_keyframe] parent_uuid_1 = @s[scores={edit=30}] self_uuid_1
scoreboard players operation @e[type=area_effect_cloud,tag=new_keyframe] parent_uuid_2 = @s[scores={edit=30}] self_uuid_2
scoreboard players operation @e[type=area_effect_cloud,tag=new_keyframe] parent_uuid_3 = @s[scores={edit=30}] self_uuid_3
...
scoreboard players operation @e[type=area_effect_cloud,tag=new_keyframe] parent_uuid_0 = @s[scores={edit=31}] self_uuid_0
scoreboard players operation @e[type=area_effect_cloud,tag=new_keyframe] parent_uuid_1 = @s[scores={edit=31}] self_uuid_1
scoreboard players operation @e[type=area_effect_cloud,tag=new_keyframe] parent_uuid_2 = @s[scores={edit=31}] self_uuid_2
scoreboard players operation @e[type=area_effect_cloud,tag=new_keyframe] parent_uuid_3 = @s[scores={edit=31}] self_uuid_3
